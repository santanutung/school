    ...
    <!-- Login Full Background -->
        ...
        <div id="login-container" class="animation-fadeIn">
            ...
            <div class="block push-bit">
                ...
                <!-- Register Form -->
                <form action="  {{route('register')}}" method="post" id="form-register" class="form-horizontal form-bordered form-control-borderless display-block">
                    @csrf
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="input-group @error('name') has-error @enderror">
                                <span class="input-group-addon"><i class="gi gi-user"></i></span>
                                <input type="text" id="register-firstname" name="name" class="form-control input-lg" placeholder="Name" required  value="{{ old('name') }}"autocomplete="name" autofocus>
                                 @error('name')
                    ...
                    <div class="form-group @error('email') has-error @enderror">
                        <div class="col-xs-12">
                            <div class="input-group">
                                ...
                                <input type="text" id="register-email"  name="email" value="{{ old('email') }}" required autocomplete="email" class="form-control input-lg" placeholder="Email">
                                 @error('email')
                                    <span class="help-block">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="input-group @error('password') has-error @enderror">
                                ...
                                <input type="password" id="register-password"  class="form-control input-lg" placeholder="Password"  name="password" required autocomplete="new-password">
                                 @error('password')
                                    <span class="help-block">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="gi gi-asterisk"></i></span>
                                <input type="password" id="register-password-verify" name="password_confirmation" required autocomplete="new-password" class="form-control input-lg" placeholder="Verify Password">
                            </div>
                        </div>
                    </div>
